        ...
        {step.options.map((option, index) => {
          ...
          return (
            <button
              ...
              className={`flex min-h-16 w-full items-center justify-center rounded-xl bg-white px-6 py-3 text-2xl font-medium tracking-[-0.5px] text-black transition-[border-color,box-shadow,transform] duration-200 animate-in fade-in slide-in-from-bottom-2 animation-duration-500 fill-mode-backwards ${
                selected
