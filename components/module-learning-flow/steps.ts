...
function buildCruceSteps(): Step[] {
  return [
    ...
    },
    {
      ...
      options: [
        'Superioridad numérica frente al ejército realista',
        'Planificación logística y uso de seis pasos cordilleranos',
        'Apoyo militar y económico de potencias europeas',
        'Improvisación sin coordinación con los patriotas chilenos',
      ],
      correctIndex: 1,
    },
    {
